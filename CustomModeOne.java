public class CustomModeOne implements GameMode {
    ...
    public void applySettings(Player player, Ghost[] ghosts) {
        ...
        if (ghosts == null || ghosts.length < 4) return;
        ...
        if (!isReversed) {
            ...
            if (targetsLeft <= 0) {
                ...
                ghosts[0].x = 180; ghosts[0].y = 180;


                ghosts[1].x = 200; ghosts[1].y = 180;


                ghosts[2].x = 220; ghosts[2].y = 180;


                ghosts[3].x = 220; ghosts[3].y = 180;
